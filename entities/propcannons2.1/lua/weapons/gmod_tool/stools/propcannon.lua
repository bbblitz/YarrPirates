...
if (SERVER) then
	...
	duplicator.RegisterEntityClass( "gmod_propcannon", MakeCannon, "Pos", "Ang", "numpadKey", "fireForce", "cannonModel", "fireModel", "recoilAmount", "fireDelay", "killDelay", "explosivePower", "explosiveRadius", "fireEffect", "fireExplosives");
else
...
function TOOL:RightClick(tr)
	...
	if(tr.Entity:IsValid() && tr.Entity:GetClass() == "prop_physics") then

		local model=tr.Entity:GetModel();
		if(util.IsValidModel(model)) then
			Msg("Selecting ammo: "..model)
		 	self:GetOwner():ConCommand("propcannon_ammo_model "..model.."\n")
